...
import com.mangosociety.friendlychallengetime.shared.component.game.create.friends.DefaultCreateGameFriendsComponent
import com.mangosociety.friendlychallengetime.shared.component.game.create.type.CreateGameTypeComponent
import com.mangosociety.friendlychallengetime.shared.component.game.create.type.DefaultCreateGameTypeComponent
import com.mangosociety.friendlychallengetime.shared.component.game.process.DefaultGameProcessComponent
import com.mangosociety.friendlychallengetime.shared.component.game.process.GameProcessComponent
import com.mangosociety.friendlychallengetime.shared.component.main.DefaultMainComponent
import com.mangosociety.friendlychallengetime.shared.component.main.MainComponent
import com.mangosociety.friendlychallengetime.shared.component.questioning.DefaultQuestioningComponent
...
import com.mangosociety.friendlychallengetime.shared.component.signIn.DefaultSignInComponent
import com.mangosociety.friendlychallengetime.shared.component.signIn.SignInComponent
import com.mangosociety.friendlychallengetime.shared.component.signUp.DefaultSignUpComponent
...
class DefaultRootComponent(
    ...
    private fun child(config: Config, childComponentContext: ComponentContext): Child =
        when (config) {
            is Config.SignIn -> Child.SignIn(signInComponent(childComponentContext))
            is Config.SignUp -> Child.SignUp(signUpComponent(childComponentContext))
